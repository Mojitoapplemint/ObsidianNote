...
$$=p_{1}^{a_{1}}\left( 1-\frac{1}{p_{1}} \right)p_{2}^{a_{2}}\left( 1-\frac{1}{p_{2}} \right)\dots p_{n}^{a_{n}}\left( 1-\frac{1}{p_{n}} \right)$$
$$=p_{1}^{a_{1}}p_{2}^{a_{2}}\dots p_{n}^{a_{n}}\left( 1-\frac{1}{p_{1}} \right)\left( 1-\frac{1}{p_{2}} \right)\dots\left( 1-\frac{1}{p_{n}} \right)$$
$$=n\cdot \prod^{n}_{i=1}\left( 1-\frac{1}{p_{i}} \right)$$