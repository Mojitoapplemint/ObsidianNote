...
For each papir of states $p$ and $q$ in $P$, the grammar will have  avariable $A_{pq}$.
...
1. Initially pushed symbol will be popped at the end of $x$
	- The stack would never be empty during the computation
2. Or, popped some point before the end of $x$
