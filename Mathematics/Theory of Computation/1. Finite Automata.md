...
- $Q=Q_{1}\times Q_{2}$
- $\delta((q_{1},q_{2}), e)=(\delta_{1}(q_{1}, e), \delta(q_{2},e))$
- $q_{0}=(q_{0,1}, q_{0,2})$
...
![[Pasted image 20250117115503.png|200]]
![[Pasted image 20250117115531.png|350]]

Then,
![[Pasted image 20250117115611.png|350]]

![[Pasted image 20250117115726.png|350]]
