...
$$\vec{u}_1 = \frac{\vec{v}_1}{\|\vec{v}_1\|} \quad \text{and} \quad \vec{u}_k = \frac{\vec{v}_k - \displaystyle\sum_{j=1}^{k-1} \langle \vec{v}_k, \vec{u}_j \rangle \vec{u}_j}{\Big|\Big|\vec{v}_k - \displaystyle\sum_{j=1}^{k-1} \langle \vec{v}_k, \vec{u}_j \rangle \vec{u}_j\Big|\Big|}$$
