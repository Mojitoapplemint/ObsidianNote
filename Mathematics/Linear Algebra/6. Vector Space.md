...
4. Is there $\vec{0}\in\mathcal{F}$ with $\forall \text{ }\vec{v}\in\mathcal{F}, \vec{v}+\vec{0}=\vec{v}$
- Let $\vec{0}$ be $0(x)=0$

5. Is there $-\vec{v}\in\mathcal{F}$ for any $\vec{v}\in\mathcal{F}$ such that $\vec{v}+(-\vec{v})=\vec{0}$
- $-f(x)$
