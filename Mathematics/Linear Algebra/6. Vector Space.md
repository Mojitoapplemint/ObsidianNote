...
By condition 6), $c\vec{v}\in\mathcal{S}$, thus axiom 1 hold
...
3. Since $\mathcal{S}\subseteq\mathcal{V}$, $\vec{v},\vec{w}, \vec{x}\in\mathcal{V}$. Since $\mathcal{V}$ is a vector space, $(\vec{v}+\vec{w})+\vec{x}=\vec{w}+(\vec{v}+\vec{x})$
4. Since $\mathcal{V}$ is a vector space, $\exists \text{ }\vec{0\in\mathcal{V}}$ such that $\forall \text{ }\vec{v}\in\mathcal{V}$, $\vec{v}+\vec{0}=\vec{v}$
	- Then $\forall \text{ }\vec{w}\in\mathcal{S}, \vec{w}\in \mathcal{V}$, thus $\vec{w}+\vec{0}+\vec{w}$
5. 