...
$\epsilon$-Nash Equilibrium relaxes the strict Nash equilibrium by requiring that no agent can improve its extected returns by more than some amount $\epsilon>0$ when deviting from its policy in the equilibrium
