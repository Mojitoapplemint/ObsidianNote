...
- Loss Function: `CategoricalCrossentropy()`
	- This requires [[AI & TensorFlow/TensorFlow Bootcamp/1. TF Fundamentals#One-Hot Encoding|one_hot]] representation of labels
	- For `int` labes, use `SparseCategoricalCrosentropy()`
- Output layer activation: `softmax`

## Creating Confusion Matrix
The result of evaluating model would be probability matrics. sICNE